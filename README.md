# Cilist
Simple CRUD app built with MySQL, ExpressJS, React, & Node.Edit
...
## Database
First you need to create database & user in MySQL in order to connect `Backend` to `Database` aaaabbbbcccdddeeeffff.
